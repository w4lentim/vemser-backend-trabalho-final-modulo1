...
--------------------------------------------------------------------------------------------------
INSERT INTO VEM_SER.CLIENTE (ID_CLIENTE, CPF, TELEFONE, ENDEREÇO) VALUES (SEQ_CLIENTE.nextval, '000.000.000-10', '(61)99999-9999', 'Rua Presidente Dutra, 09, Centro');

INSERT INTO VEM_SER.CLIENTE (ID_CLIENTE, CPF, TELEFONE, ENDEREÇO) VALUES (SEQ_CLIENTE.nextval, '000.000.000-11', '(61)99999-9998', 'Rua Presidente Dutra, 154, Bairro Maria Cândida');

INSERT INTO VEM_SER.CLIENTE (ID_CLIENTE, CPF, TELEFONE, ENDEREÇO) VALUES (SEQ_CLIENTE.nextval, '000.000.000-22', '(61)99999-9997', 'Avenida Antônio Carlos Guimarães, 154A, Centro');

INSERT INTO VEM_SER.CLIENTE (ID_CLIENTE, CPF, TELEFONE, ENDEREÇO) VALUES (SEQ_CLIENTE.nextval, '000.000.000-33', '(61)99999-9996', 'Avenida Boolevard, apartamento 1001, Parque dos Viajantes');

INSERT INTO VEM_SER.CLIENTE (ID_CLIENTE, CPF, TELEFONE, ENDEREÇO) VALUES (SEQ_CLIENTE.nextval, '000.000.000-44', '(61)99999-9995', 'Avenida das Flores, apartamento 505, Praça das Flores');
---------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------
INSERT INTO VEM_SER.CARRO (ID_CARRO, ID_ALUGUEL, ALUGADO, NOME, MARCA, CLASSE, QUANTIDADE_PASSAGEIROS, KM_RODADOS, VALOR_DIARIA) VALUES(SEQ_CARRO.nextval, 1, 'S', 'Pálio', 'Fiat', 'C', 5, 20000, 100);
