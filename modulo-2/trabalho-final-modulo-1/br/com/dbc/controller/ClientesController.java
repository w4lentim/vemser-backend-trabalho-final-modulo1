...
public class ClientesController {
    ...
    public ArrayList<Cliente> inicializarClientes() {
        ...
        retorno.add(new Cliente(1, "88822233322", "859182845", "Rua das Flores", 900.00));
        retorno.add(new Cliente(2, "22233311144", "55555566", "Rua das Pedras", 800.00));
        retorno.add(new Cliente(3, "8887776655", "333344442", "Rua dos Sapatos", 1000.00));
        return retorno;
    }
